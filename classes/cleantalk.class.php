/*  cleantalk.class.forVB.php - modified for vB*/
/**
 ...
 * @package Cleantalk
 * @subpackage Base
 * @author Cleantalk team (welcome@cleantalk.ru)
 * @copyright (C) 2013 CleanTalk team (http://cleantalk.org)
...
// end of cleantalk.class.forVB.php